    ...
    <section className={props.className}>
      ...
      <div>
        ...
        <Input
          ...
          placeholder="e.g. Dabras Community Hub"
      ...
      <div className="mt-9">
        ...
        <Input
          className="w-full mt-2"
          placeholder="e.g. The home for all things Dabra"
        ...
        {props.symbolIsValid === false ? (
          ...
          <div className="flex items-center text-xs mt-1 truncate">
            ...
            <a
              ...
              rel="noreferrer"
            >
              {`https://app.dabra.today/realm/${encodeURIComponent(
                props.symbol || props.publicKey.toBase58(),
              )}`}
            </a>
          </div>
      ...
      <div className="mt-12">
        ...
        <Input
          className="w-full mt-2"
          placeholder="e.g. https://www.dabra.today"
      ...
      <div className="mt-8">
        ...
        <Input
          className="w-full mt-2"
          placeholder="e.g. https://docs.dabra.today"
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-8">
        ...
        <div>
          ...
          <Input
            className="w-full mt-2"
            placeholder="e.g. https://discord.com/dabra"
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-8">
        <div>
          ...
          <Input
            className="w-full mt-2"
            placeholder="e.g. https://github.com/dabra"
        ...
        <div>
          ...
          <Input
            className="w-full mt-2"
            placeholder="e.g. https://instagram.com/dabra"
