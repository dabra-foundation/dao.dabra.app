...
export function Content(props: Props) {
  ...
  const [followedResp] = useQuery(gql.followedDabraResp, {
    query: gql.followedDabra,
  });
      ...
      <div className="max-w-7xl mx-auto px-4 relative w-full md:px-8">
        ...
        >
          <div className="flex items-baseline relative overflow-visible -mx-4 md:-mx-2">
            ...
            {props.userIsAdmin && (
              <Link passHref href={`/dabra/${props.realmUrlId}/hub/edit`}>
                <a
                  className={cx(
                    'flex',
                    'items-center',
          ...
          <div className="flex items-center">
            ...
            {pipe(
              ...
              RE.match(
                ...
                ({ me }) => {
                  if (me) {
                    const isCurrentlyFollowing = me.followedDabra
          ...
          <NavigationMenu.Root>
            <NavigationMenu.List className="flex items-center sm:space-x-2 md:space-x-3">
              ...
              {!props.realm.equals(ECOSYSTEM_PAGE) && (
                <Tab
                  href={`/dabra/${props.realmUrlId}/hub`}
