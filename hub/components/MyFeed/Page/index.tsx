...
export function Page(props: Props) {
  ...
  return pipe(
    ...
    RE.match(
      ...
      ({ followedDabraFeed }, isStale) => {
        const feedItems = followedDabraFeed.edges.filter((feedItem) => {
        ...
        return (
          <div className={props.className}>
            ...
            <EnteredViewport
              onEnteredViewport={() => {
                if (followedDabraFeed.pageInfo.endCursor) {
                  props.onLoadMore?.(followedDabraFeed.pageInfo.endCursor);
