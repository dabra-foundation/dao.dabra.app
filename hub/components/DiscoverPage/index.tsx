        ...
        >
          ...
          >
            ...
            <div className="mt-16 md:pr-16 max-w-[1188px]">
              <Hackathon dabra={discoverPage.hackathonWinners} />
              <Popular className="mt-16" dabra={discoverPage.popular} />
              <NotableNFTs
                className="mt-16"
                dabra={discoverPage.nftCollections}
              />
              <NotableDefi className="mt-16" dabra={discoverPage.defi} />
              <NotableGames className="mt-16" dabra={discoverPage.gaming} />
              <NotableDAOTooling
                className="mt-16"
                dabra={discoverPage.daoTooling}
              />
              <NotableWeb3 className="mt-16" dabra={discoverPage.web3} />
