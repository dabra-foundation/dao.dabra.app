...
const MOBILE_WALLET_PROVIDER = {
  ...
  adapter: new SolanaMobileWalletAdapter({
    ...
    appIdentity: {
      icon: '/img/logo-dabra.png',
      name: 'Dabra',
      uri: 'https://app.dabra.foundation',
    },
  ...
  adapter: new WalletConnectWalletAdapter({
    ...
    options: {
      ...
      metadata: {
        name: 'Dabra',
        description:
          'Powered by Solana, Dabra is a hub for communities to share ideas, make decisions, and collectively manage treasuries.',
        url: 'https://dao.dabra.app/img/logo-dabra.png',
        icons: ['https://dao.dabra.app'],
      },
    },
  }),
}
